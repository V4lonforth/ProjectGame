...
namespace AndroidGame.GameObjects.Ships
{
    public class Ship : BaseShip, IPhysicalObject, GameLib.GameObjects.Base.IDrawable
    {
        ...
        public Ship(ShipInfo shipInfo, BaseProjectilesController projController, ParticleSystem parSystem, int team, Vector2 pos, int id) : base(shipInfo, projController, team, pos, id)
        {
